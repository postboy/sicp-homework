...
(A (set-register-contents! gcd-machine 'a 206) 'done)
(A (set-register-contents! gcd-machine 'b 40) 'done)
(A (start gcd-machine) 'done)
(A (get-register-contents gcd-machine 'a) 2)
