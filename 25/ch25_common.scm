...
(define (install-polynomial-package)
  ...
  (define (poly-wrapper-2to1 f p1 p2)
    ...
    (define res-terms (f (term-list (car prepared)) (term-list (cadr prepared))))
    (make-poly res-var res-terms))
  (define (poly-wrapper-2to2 f p1 p2)
    (define prepared (same-var-poly p1 p2))
    (define res-var (variable (car prepared)))
    (define res-terms (f (term-list (car prepared)) (term-list (cadr prepared))))
    (list (make-poly res-var (car res-terms)) (make-poly res-var (cadr res-terms))))
  (define (add-poly p1 p2)
    (poly-wrapper-2to1 add-terms p1 p2))
  (define (mul-poly p1 p2)
    (poly-wrapper-2to1 mul-terms p1 p2))
  (define (div-poly p1 p2)
    (poly-wrapper-2to2 div-terms p1 p2))
  (define (gcd-poly p1 p2)
    (poly-wrapper-2to1 gcd-terms p1 p2))
  (define (reduce-poly p1 p2)
    (poly-wrapper-2to2 reduce-terms p1 p2))
  ; interface to rest of the system
